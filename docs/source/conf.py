...
def _resolve_version() -> str:
    ...
    try:
        return pkg_version("spectral-unmixing")
    except PackageNotFoundError:
        pass

    # fallback: map import package -> installed distribution(s)
    try:
        dist_names = packages_distributions().get("spectral_unmixing", [])
...
html_logo = "_static/spectral_unmixing_logo_wider_transparent.png"
